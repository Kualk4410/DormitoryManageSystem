      ...
      <el-card class="login-card">
        ...
        <div class="card-title">
          <div class="logo-wrapper">
            <img src="@/assets/images/base/logo-DMS.png" class="logo">
          </div>
...
<script setup>
  ...
  const { setToken, setUserInfo, logut } = store
      ...
      if (valid) {
        ...
        setTimeout(() => {
          if (loginData.value.studentid === '012345678912345' && loginData.value.password === '012345678912345') {
            alert('登录成功')
            setToken('012345678912345')
            setUserInfo({
              name: '张三',
              studentid: '012345678912345',
              roomid: '1',
              room_name: '杏园一舍603男生寝室',
              phone: '12345678901',
...
<style scoped>
  @import url("@/assets/styles/login/structure.css");
  @import url("@/assets/styles/login/card-title.css");
  @import url("@/assets/styles/login/login-form-wrapper.css");
</style>